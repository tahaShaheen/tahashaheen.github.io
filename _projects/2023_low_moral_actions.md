...
### Avatar Robots
Imagine a world where people use robots to visit different places and countries. Unlike screens on wheels (telepresence robots), avatar robots can look like anything (think [Surrogates](https://www.imdb.com/title/tt0986263/)). One flaw of this is that it is not readily apparent to bystanders who the operator of the robot is. Malicious operators can use this anonymity to do low-moral actions, which we define as not only illegal acts but also acts that violate norms of society.

In {% cite shaheen2024lowmoralactions %}, we created a list of what low-moral actions were possible through avatar robots when operated by someone malicious and anonymous. We restricted this study to avatar robots with cameras, listening capabilities, and movement. We did not consider speaking via the robot or apendages. 
...
and what prevention mechanisms were applicable for each. 
...
This research was conducted during my master’s studies at the <a href="https://www.robot.soc.i.kyoto-u.ac.jp/en/">Human-Robot Interaction Lab</a> at <a href="https://www.kyoto-u.ac.jp/en">Kyoto University</a>. 